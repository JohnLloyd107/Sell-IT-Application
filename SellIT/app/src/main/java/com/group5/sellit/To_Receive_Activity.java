...
public class To_Receive_Activity extends AppCompatActivity {

    ImageView back;
    RecyclerView recieve_recycleview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = (ImageView) findViewById(R.id.back_ar_recieve);

        recieve_recycleview = (RecyclerView) findViewById(R.id.recycle_recieve);
        recieve_recycleview.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        total_Price = (TextView) findViewById(R.id.total_Price_txt);

        recieve_recycleview.setLayoutManager(layoutManager);


        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(To_Receive_Activity.this,UserProfile.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<CartModel> options = new FirebaseRecyclerOptions.Builder<CartModel>()
                .setQuery(prodref.child("Admin View").child(Prevalent.currentUser.getPhonenumber()).child("Products")
                        .orderByChild("status").startAt("Approved").endAt("Approved"+"\uf8ff"),CartModel.class).build();
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull CartModel model) {
                ...
                if (status.equals("Approved")){
                    ...
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(To_Receive_Activity.this, View_Product_Activity.class);
        ...
        recieve_recycleview.setAdapter(adapter);
